...
public class FairfieldUStoreApplication {
	...
	CommandLineRunner runner(ProductService productService) {
		return args -> {
			productService.save(new Product(1L, "Women’s Pullover Sweatshirt", 60.00, "https://bkstr.scene7.com/is/image/Bkstr/1276-Q10-MS-Snowy-Garnet?$HomePageRecs_ET$"));
			...
			productService.save(new Product(3L, "Jacket", 60.00, "https://bkstr.scene7.com/is/image/Bkstr/1276-16601-AXRDA-Graphite?$HomePageRecs_ET$"));
			productService.save(new Product(4L, "Stags UText Gloves", 15.00, "https://bkstr.scene7.com/is/image/Bkstr/1276-1016-MSCT-Red?$HomePageRecs_ET$"));
			...
			productService.save(new Product(9L, "Bulb Ornament", 15.00, "https://bkstr.scene7.com/is/image/Bkstr/6-62-PZ--2H--Silver?$HomePageRecs_ET$"));
